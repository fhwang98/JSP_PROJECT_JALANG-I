...
#board-list > div > table > tbody > tr:nth-child(13) > td > a {
        ...
        <div class="container">
            <table class="board-table">
				<tbody>        
         		...
         		<tr>
            		<th>작성날짜 </th>
            		<td>${dto.faqWriteDate}</td>
         		</tr>
				</tbody>
            </table>  
            <div class="button-group">
			<button class="button-79" role="button" onclick="location.href='/jr/faq/admin/faqadminlist.do';">목록</button>
			<button class="button-79" role="button" onclick="location.href='/jr/faq/admin/faqadminedit.do?Seq=${dto.faqSeq}';">수정</button>
			<button class="button-79" role="button" onclick="location.href='/jr/faq/admin/faqadmindel.do?Seq=${dto.faqSeq}';">삭제</button>
			</div>
			</div>
        </div>
    </div>
