...
#board-list > div > form > table > tbody > tr:nth-child(2) > td > textarea {
	width: 650px;
	height: 150px;
}
...
<section class="notice">
  ...
  <!-- board list area -->
    <div id="board-list">
        <div class="container">
        	<form method="POST" action="/jr/faq/admin/faqadminedit.do">
            <table class="board-table">
				<tbody>
         		<tr>
            		<th>제목 </th>
            		<td><input type="text" name="faqtitle" required value="${dto.faqtitle}"></td>
         		</tr>	
         		<tr>
            		<th>내용 </th>
            		<td><textarea name="faqContent" required>${dto.faqContent}</textarea></td>
         		</tr>	
				</tbody>
            </table>
			...
			<button class="button-79" role="button" onclick="location.href='/jr/faq/admin/faqadmindetail.do?Seq=${dto.faqSeq}';">돌아가기</button>
