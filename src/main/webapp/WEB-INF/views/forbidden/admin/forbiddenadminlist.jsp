    ...
    <div id="board-list">
        <div class="container">
        	<div class="button-group">
				<button class="button-79" role="button" onclick="location.href='/jr/forbidden/admin/forbiddenadminadd.do';">등록하기</button>
			</div>
            <table class="board-table">
                <thead>
                    <th scope="col" class="th-num">번호</th>
                    <th scope="col" class="th-username">금지어</th>                                 
                </tr>
                </thead>
				<tbody>
        				...
        				<tr>
        					...
        					<td><a href="/jr/forbidden/admin/forbiddenadmindetail.do?forbiddenSeq=${dto.forbiddenSeq}">${dto.forbidden}</td>	
        				</tr>
    				</c:forEach>
				</tbody>
            </table>
