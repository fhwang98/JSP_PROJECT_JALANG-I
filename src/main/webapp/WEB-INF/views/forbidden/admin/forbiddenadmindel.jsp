...
<section class="notice">
  ...
  <!-- board list area -->
    <div id="board-list">
        <div class="container">
        	<form method="POST" action="/jr/forbidden/admin/forbiddenadmindel.do">
            <div class="button-group">
			<button class="button-79" role="button" onclick="location.href='/jr/forbidden/admin/forbiddenadmindetail.do?forbiddenSeq=${dto.forbiddenSeq}';">돌아가기</button>
			<button class="button-79" role="button">삭제하기</button>
			</div>
			<input type="hidden" name="forbiddenSeq" value="${forbiddenSeq}">
			</form>
			</div>
        </div>
    </div>
