  ...
  <!-- board list area -->
    <div id="board-list">
        <div class="container">
			...
			<button class="button-79" role="button" onclick="location.href='/jr/forbidden/admin/forbiddenadminlist.do';">목록</button>
			<button class="button-79" role="button" onclick="location.href='/jr/forbidden/admin/forbiddenadmindel.do?forbiddenSeq=${dto.forbiddenSeq}';">삭제</button>
			</div>
			</div>
        </div>
    </div>
