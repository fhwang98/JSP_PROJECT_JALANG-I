...
#board-list > div > form > table > tbody > tr > td > input[type=text] {
	width: 650px;
}
...
#board-list > div > form > table > tbody > tr:nth-child(8) > td > textarea {
	width: 650px;
	height: 50px;
}
...
<section class="notice">
  ...
  <!-- board list area -->
    <div id="board-list">
        <div class="container">
        	<form method="POST" action="/jr/crt/admin/crtadminedit.do">
            <table class="board-table">
				<tbody>        
				 <tr>
            		<th>자격증명 </th>
            		<td><input type="text" name="crtName" required value="${dto.crtName}"></td>
         		</tr>
         		<tr>
           			<th>자격증 분류 번호 </th>
            		<td><input type="text" name="crtTypeSeq" required value="${dto.crtTypeSeq}"></td>
         		</tr>
         		<tr>
            		<th>유효기간 </th>
            		<td><input type="text" name="expiration" required value="${dto.expiration}"></td>
         		</tr>
         		<tr>
            		<th>시행기관 번호</th>
            		<td><input type="text" name="agencySeq" required value="${dto.agencySeq}"></td>
         		</tr>
         		<tr>
            		<th>정기유무 </th>
            		<td><input type="text" name="isRoutine" required value="${dto.isRoutine}"></td>
         		</tr>
         		<tr>
            		<th>난이도 </th>
            		<td><input type="text" name="difficulty" required value="${dto.difficulty}"></td>
         		</tr>
         		<tr>
            		<th>좋아요수 </th>
            		<td><input type="text" name="likeCnt" required value="${dto.likeCnt}"></td>
         		</tr>
         		<tr>
            		<th>응시자격 분류</th>
            		<td><textarea name="qualificationCate" required>${dto.qualificationCate}</textarea></td>
         		</tr>
         		<tr>
            		<th>응시자격 </th>
            		<td><textarea name="qualification" required>${dto.qualification}</textarea></td>
         		</tr>
         		<tr>
            		<th>자격증 설명 </th>
            		<td><textarea name="crtInfo" required>${dto.crtInfo}</textarea></td>
         		</tr>	
         		<tr>
            		<th>누적 응시자수 </th>
            		<td><input type="text" name="totalCnt" required value="${dto.totalCnt}"></td>
         		</tr>	
         		<tr>
            		<th>직무내용 </th>
            		<td><textarea name="jobDesc" required>${dto.jobDesc}</textarea></td>
         		</tr>	
				</tbody>
            </table>
			...
			<button class="button-79" role="button">수정</button>
			<button class="button-79" role="button" onclick="location.href='/jr/crt/admin/crtadmindetail.do?crtSeq=${dto.crtSeq}';">돌아가기</button>
			<input type="hidden" name="crtSeq" value="${dto.crtSeq}">
			</form>
			</div>
			</div>
        </div>
