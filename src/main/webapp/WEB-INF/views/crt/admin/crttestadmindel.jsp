...
<section class="notice">
  ...
  <!-- board list area -->
    <div id="board-list">
        <div class="container">
        	<form method="POST" action="/jr/crt/admin/crttestadmindel.do">
            <div class="button-group">
			<button class="button-79" role="button" onclick="location.href='/jr/crt/admin/crttestadmindetail.do?crtSeq=${dto.crtSeq}';">돌아가기</button>
