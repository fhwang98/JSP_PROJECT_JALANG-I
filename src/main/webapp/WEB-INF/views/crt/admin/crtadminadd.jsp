...
<section class="notice">
  ...
  <!-- board list area -->
    <div id="board-list">
        <div class="container">
        	<form method="POST" action="/jr/crt/admin/crtadminadd.do">
			...
			<button class="button-79" role="button" onclick="location.href='/jr/crt/admin/crtadminlist.do';">돌아가기</button>
			</div>
			</form>
			</div>
        </div>
