    ...
    <div id="board-list">
        <div class="container">
        	<div class="button-group">
				<button class="button-79" role="button" onclick="location.href='/jr/crt/admin/crtadminadd.do';">등록하기</button>
			</div>
            <table class="board-table">
                <thead>
                    <th scope="col" class="th-num">자격증 번호</th>
                    <th scope="col" class="th-username">자격증명</th>
                    <th scope="col" class="th-id">자격증분류</th>
                    <th scope="col" class="th-startdate">시행기관</th>                                     
                    <th scope="col" class="th-decacccount">좋아요수</th>                                     
                    <th scope="col" class="th-decacccount">응시료</th>                                  
                </tr>
                </thead>
				<tbody>
        				...
        				<tr>
            				...
            				<td><a href="/jr/crt/admin/crtadmindetail.do?crtSeq=${dto.crtSeq}&search=${map.search}&column=${map.column}&word=${map.word}">${dto.crtName}</td> 
            				<td>${dto.crtType}</td> 
