        ...
        <div class="container">
            <table class="board-table">
				<tbody>        
         		...
         		<tr>
            		<th>시험유형 번호</th>
            		<td>${dto.crtTestTypeSeq}</td>
         		</tr>
         		<tr>
            		<th>응시료 </th>
            		<td><fmt:formatNumber value="${dto.examPay}" pattern="#,##0"/>원</td>
         		</tr>
         		<tr>
            		<th>유효기간 </th>
            		<td>${dto.expiryDate}</td>
			...
			<button class="button-79" role="button" onclick="location.href='/jr/crt/admin/crttestadminlist.do';">목록으로</button>
			<button class="button-79" role="button" onclick="location.href='/jr/crt/admin/crttestadminedit.do?crtSeq=${dto.crtSeq}';">수정</button>
			<button class="button-79" role="button" onclick="location.href='/jr/crt/admin/crttestadmindel.do?crtSeq=${dto.crtSeq}';">삭제</button>
			</div>
			</div>
        </div>
    </div>
