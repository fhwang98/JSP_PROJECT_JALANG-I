    ...
    <div id="board-list">
        <div class="container">
        	<div class="button-group">
				<button class="button-79" role="button" onclick="location.href='/jr/crt/admin/crttestadminadd.do';">등록하기</button>
			</div>
            <table class="board-table">
                <thead>
                    <th scope="col" class="th-num">자격증 시험 번호</th>
                    <th scope="col" class="th-num">자격증명</th>
                    <th scope="col" class="th-username">시험명</th>
                    <th scope="col" class="th-id">시험유형</th>                                
                </tr>
                </thead>
				<tbody>
						<c:forEach items="${list}"  var="dto" varStatus="status">
        				<tr>
        					<td>${dto.crtTestSeq}</td>
        					<td>${dto.crtName}</td>
            				<td><a href="/jr/crt/admin/crttestadmindetail.do?crtSeq=${dto.crtSeq}">${dto.crtTestName}</td> 
            				<td>${dto.testType}</td>
        				</tr>
    				</c:forEach>
				</tbody>
