...
<section class="notice">
  ...
  <!-- board list area -->
    <div id="board-list">
        <div class="container">
        	<form method="POST" action="/jr/crt/admin/crttestadminadd.do">
            <table class="board-table">
				<tbody>        
         		...
         		<tr>
            		<th>문항유형 </th>
            		<td><textarea name="questionType" required>${dto.questionType}</textarea></td>
         		</tr>
         		<tr>
            		<th>문항수 </th>
            		<td><textarea name="qustionNum" required>${dto.qustionNum}</textarea></td>
         		</tr>
         		<tr>
            		<th>시험시간 </th>
            		<td><textarea name="testTime" required>${dto.testTime}</textarea></td>
         		</tr>	
				</tbody>
            </table>
			...
			<button class="button-79" role="button" onclick="location.href='/jr/crt/admin/crttestadminlist.do';">돌아가기</button>
			</div>
			</form>
			</div>
        </div>
