  ...
  <!-- board list area -->
    <div id="board-list">
        <div class="container">
			...
			<button class="button-79" role="button" onclick="location.href='/jr/crt/admin/crtschadminlist.do';">목록으로</button>
			<button class="button-79" role="button" onclick="location.href='/jr/crt/admin/crtschadminedit.do?crtSchSeq=${dto.crtSchSeq}';">수정</button>
			<button class="button-79" role="button" onclick="location.href='/jr/crt/admin/crschadmindel.do?crtSchSeq=${dto.crtSchSeq}';">삭제</button>
			</div>
			</div>
        </div>
    </div>
