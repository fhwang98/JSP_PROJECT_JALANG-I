...
<section class="notice">
  ...
  <!-- board list area -->
    <div id="board-list">
        <div class="container">
        	<form method="POST" action="/jr/crt/admin/crtschadminadd.do">
            <table class="board-table">
				<tbody>        
         		...
         		<tr>
            		<th>누적 응시자수 </th>
            		<td><textarea name="totalCnt" required>${dto.totalCnt}</textarea></td>
         		</tr>	
         		<tr>
            		<th>직무내용 </th>
			...
			<button class="button-79" role="button" onclick="location.href='/jr/crt/admin/crtschadminlist.do';">돌아가기</button>
			</div>
			</form>
			</div>
        </div>
